...
console.log(rando);
 // TODO: In a sentence or two, explain why the previous line of code threw an error when we changed the variable declaration from `var to `let`.
  // Changing the variable declaration from `var` to `let` creates an error that disables images in the web browser because let declarations are limited specifically to the scope of the block and var decalares a variable regardless of block scope.
console.log(viewed);
